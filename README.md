...
📍 Bengaluru, India | Open to Pune / Chennai / HYD
...
**Programming & Data**
- Python, SQL (MySQL, PostgreSQL), C

**Machine Learning**
- Scikit-learn, TensorFlow, PyTorch  
- Regression, Classification, Clustering  
- Feature Engineering, Data Validation, Model Evaluation

**LLMs & NLP**
- GPT, BERT, Transformer-based models  
- Prompt Engineering  
- API-based model inference

**Data Visualization**
- Streamlit, PowerBI, Dash  
- Matplotlib
...
- Customer segmentation & data mining systems  
